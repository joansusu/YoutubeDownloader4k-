...
export async function generateMetadata({
  ...
  return {
    title: dict.mp4Page.title,
    description: dict.mp4Page.description,
    alternates: generateHreflang(lang, "youtube-to-mp4"),
  };
}
...
export default async function YtoMP4Page({
  params: { lang },
}: {
  params: { lang: string };
}) {
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl font-bold mb-10">{dict.mp4Page.h1}</h1>
            <p className="text-0.5xl text-gray-600 mb-1">{dict.mp4Page.p1}</p>
          </div>
        </div>
      </section>
