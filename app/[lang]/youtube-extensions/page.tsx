...
export async function generateMetadata({
  ...
  return {
    title: dict.extPage.title,
    description: dict.extPage.description,
    alternates: generateHreflang(lang, "youtube-extensions"),
  };
}
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {dict.extPage.h1}
            <p className="text-0.5xl text-gray-600 mb-1">{dict.extPage.p1}</p>
          </div>
        </div>
      </section>
