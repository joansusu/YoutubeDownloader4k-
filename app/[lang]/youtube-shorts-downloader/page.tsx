...
export async function generateMetadata({
  ...
  return {
    title: dict.shortsPage.title,
    description: dict.shortsPage.description,
    alternates: generateHreflang(lang, "youtube-shorts-downloader"),
  };
}
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl font-bold mb-10">{dict.shortsPage.h1}</h1>
