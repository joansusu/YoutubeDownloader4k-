      ...
      <section className="bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl font-bold mb-10">{dict.home.h1}</h1>
            <h2 className="text-2xl font-bold mb-6">{dict.home.subtitle}</h2>
            <p className="text-0.5xl text-gray-600 mb-1">{dict.home.intro}</p>
          </div>
        </div>
      </section>
